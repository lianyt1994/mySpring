...
public class ScanUtil {
	...
	public static List<String> getComponentList(String packageName){
		...
		//将扫描的接口和其实现类，使用map对应上,模仿spring接口注入
	...
	private static <A extends Annotation> void addNewAnnotation(Class<A> annotationClass, Class<?> aClass) throws ClassNotFoundException {
		//如果类上有注解
